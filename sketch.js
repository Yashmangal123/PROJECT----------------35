...
function draw() {  
  ...
  if(foodS != 0){
    fill("white")
  text("Note: After You press the Up arrow the dog will again come to rest after drinking milk",30,90);
  textSize(20);
    text("Note: Press Up Arrow Key to Feed Drago milk",50,50);
    text("Note: Press Down Arrow Key to again Feed it again",30,70);
    textSize(30);
    ...
    if(foodS == 0){
      fill("White");
      textSize(20);
      text("Press Space Key to Refill milk",120,50);
      textSize(80);
